...
def plot_historic_data(data, ticker, start_date, end_date, plot_type='Averages'):
    data['date'] = pd.to_datetime(data['date']).dt.date
    start_date = pd.to_datetime(start_date).date()
    end_date = pd.to_datetime(end_date).date()
    
    data = calculate_indicators(data, plot_type)
...
def calculate_indicators(data, plot_type):
