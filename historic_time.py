...
def plot_historic_data(data, ticker, start_date, end_date, ma:bool=True, bb:bool=True, vwap:bool=True, rsi:bool=True):
    ...
    if any([ma, bb, vwap]):  # If at least one of ma, bb, or vwap is True
...
def calculate_indicators(data, ma, bb, vwap, rsi):
